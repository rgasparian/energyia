    ...
    <div style={{
      ...
      >
        ...
        <svg
          ...
          style={{ flexShrink: 0, transition: "transform .3s", transform: open ? "rotate(45deg)" : "rotate(0deg)" }}
        >
...
export default function MatrixPage() {
  return (
    <div style={{ fontFamily: "'DM Sans',sans-serif", background: "#080808", color: "#ffffff", overflowX: "hidden" }}>
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .btn-orange-mx,
        .btn-orange-mx:link,
        .btn-orange-mx:visited,
        .btn-orange-mx:hover,
        .btn-orange-mx:focus,
        .btn-orange-mx:active {
        ...
        .btn-orange-full-mx,
        .btn-orange-full-mx:link,
        .btn-orange-full-mx:visited,
        .btn-orange-full-mx:hover,
        .btn-orange-full-mx:focus,
        .btn-orange-full-mx:active {
          display:block!important;
          width:100%!important;
          padding:14px 16px!important;
          background-color:#F57C00!important;
        ...
        .tool-card-mx:hover{border-color:rgba(245,124,0,0.3)!important;background:rgba(245,124,0,0.04)!important;}

        @keyframes fadeUp{from{opacity:0;transform:translateY(24px)}to{opacity:1;transform:translateY(0)}}
        .hero-content-mx>*{animation:fadeUp .6s ease both;}
        .hero-content-mx>*:nth-child(1){animation-delay:.05s}
        .hero-content-mx>*:nth-child(2){animation-delay:.15s}
        .hero-content-mx>*:nth-child(3){animation-delay:.25s}
        .hero-content-mx>*:nth-child(4){animation-delay:.35s}
        .hero-content-mx>*:nth-child(5){animation-delay:.42s}

        @media(max-width:680px){
          .prob-grid-mx,.tools-grid-mx,.bonus-grid-mx,.combos-grid-mx,.pers-grid-mx{grid-template-columns:1fr!important;}
          .tool-wide-mx{grid-column:auto!important;}
          .hero-mx{padding:60px 0 50px!important;}
          .sec-mx{padding:60px 0!important;}
        }
      `}</style>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <div style={{ fontFamily: "'Outfit',sans-serif", fontWeight: 700, fontSize: 20, letterSpacing: "-0.02em", color: "#ffffff" }}>EnergyIA</div>
              <div style={{ fontSize: 9, fontWeight: 300, letterSpacing: ".15em", color: "#888", marginTop: -4 }}>MÉTODO INTELIGENTE</div>
            </div>
          </div>
          <button className="nav-cta-mx" onClick={() => scrollTo("combos-mx")}>Ver combos</button>
        </div>
      </nav>

      {/* HERO */}
      <section className="hero-mx" style={{ padding: "100px 0 80px", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: -120, left: "50%", transform: "translateX(-50%)", width: 700, height: 500, background: "radial-gradient(ellipse,rgba(245,124,0,0.18) 0%,transparent 70%)", pointerEvents: "none" }}/>
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 1 }}>
          <div className="hero-content-mx">
            ...
            <h1 style={{ fontFamily: "'Outfit',sans-serif", fontSize: "clamp(36px,6vw,64px)", fontWeight: 800, letterSpacing: "-0.03em", lineHeight: 1.05, marginBottom: 24, color: "#ffffff" }}>
            ...
            <button className="btn-orange-mx" onClick={() => scrollTo("combos-mx")}>
              Quero o EnergyIA
      ...
      {/* PROBLEMA */}
      <section className="sec-mx" style={{ padding: "80px 0", background: "#111111", borderTop: "1px solid rgba(255,255,255,0.08)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
          ...
          <h2 style={{ fontFamily: "'Outfit',sans-serif", fontSize: "clamp(26px,4vw,38px)", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 16, color: "#ffffff" }}>Vender desconto não basta</h2>
          ...
          <div className="prob-grid-mx" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 40 }}>
            {[
      ...
      {/* SOLUÇÃO */}
      <section className="sec-mx" style={{ padding: "80px 0" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
          ...
          <h2 style={{ fontFamily: "'Outfit',sans-serif", fontSize: "clamp(26px,4vw,38px)", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 16, color: "#ffffff" }}>Consciência para o cliente.<br/>Confiança para o consultor.</h2>
          ...
          <div style={{ marginTop: 44 }}>
            {[
              ...
              <div key={s.n} style={{ display: "flex", gap: 24, alignItems: "flex-start", padding: "28px 0", borderBottom: i < 2 ? "1px solid rgba(255,255,255,0.08)" : "none" }}>
                <div style={{ width: 44, height: 44, borderRadius: "50%", background: "rgba(245,124,0,0.12)", border: "1px solid rgba(245,124,0,0.3)", color: "#F57C00", fontFamily: "'Outfit',sans-serif", fontWeight: 700, fontSize: 18, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>{s.n}</div>
                <div>
                  <div style={{ fontFamily: "'Outfit',sans-serif", fontWeight: 600, fontSize: 17, marginBottom: 6, color: "#ffffff" }}>{s.t}</div>
      ...
      <section className="sec-mx" style={{ padding: "80px 0", background: "#111111", borderTop: "1px solid rgba(255,255,255,0.08)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
          ...
          <h2 style={{ fontFamily: "'Outfit',sans-serif", fontSize: "clamp(26px,4vw,38px)", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 16, color: "#ffffff" }}>Ferramentas do combo</h2>
          ...
          <div className="tools-grid-mx" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 12, marginTop: 40 }}>
            {[
              ...
              { icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F57C00" strokeWidth="1.8"><rect x="2" y="6" width="20" height="12" rx="2"/><path d="M12 12h.01M8 12h.01M16 12h.01"/></svg>, t: "Cartão virtual", d: "Sua página com todos os seus links em um só lugar — WhatsApp, simulador, páginas, redes sociais. Profissional e fácil de compartilhar.", wide: true },
            ].map(f => (
              <div key={f.t} className={`tool-card-mx${f.wide ? " tool-wide-mx" : ""}`} style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 14, padding: 22, transition: "border-color .2s,background .2s", gridColumn: f.wide ? "1/-1" : "auto" }}>
                ...
                <div style={{ fontFamily: "'Outfit',sans-serif", fontWeight: 600, fontSize: 15, marginBottom: 6, color: "#ffffff" }}>{f.t}</div>
      ...
      <section className="sec-mx" style={{ padding: "80px 0" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
          ...
          <h2 style={{ fontFamily: "'Outfit',sans-serif", fontSize: "clamp(26px,4vw,38px)", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 40, color: "#ffffff" }}>O que vem de presente</h2>
          <div className="bonus-grid-mx" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
              ...
              <div key={b.n} style={{ border: "1px solid rgba(245,124,0,0.2)", borderRadius: 14, padding: 28, background: "rgba(245,124,0,0.04)", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ fontFamily: "'Outfit',sans-serif", fontWeight: 700, fontSize: 16, marginBottom: 8, color: "#ffffff" }}>{b.t}</div>
      ...
      <section className="sec-mx" style={{ padding: "80px 0", background: "#111111", borderTop: "1px solid rgba(255,255,255,0.08)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
          ...
          <h2 style={{ fontFamily: "'Outfit',sans-serif", fontSize: "clamp(26px,4vw,38px)", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 16, color: "#ffffff" }}>Tudo no seu nome</h2>
          ...
          <div className="pers-grid-mx" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 10, marginTop: 36 }}>
            {[
      ...
      {/* COMBOS */}
      <section id="combos-mx" className="sec-mx" style={{ padding: "80px 0" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ fontSize: 11, fontWeight: 500, letterSpacing: ".14em", color: "#F57C00", textTransform: "uppercase", marginBottom: 12 }}>Combos</div>
          <h2 style={{ fontFamily: "'Outfit',sans-serif", fontSize: "clamp(26px,4vw,38px)", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 16, color: "#ffffff" }}>Escolha seu ponto de entrada</h2>
          ...
          <div className="combos-grid-mx" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginTop: 44, alignItems: "start" }}>
            ...
            <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 18, padding: 32 }}>
              ...
              <div style={{ fontFamily: "'Outfit',sans-serif", fontWeight: 700, fontSize: 20, marginBottom: 6, color: "#ffffff" }}>Método EnergyIA</div>
              ...
              <div style={{ fontFamily: "'Outfit',sans-serif", fontSize: 36, fontWeight: 800, color: "#F57C00", lineHeight: 1, marginBottom: 4 }}>R$ 17</div>
              <div style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", marginBottom: 20 }}>ou 2 x R$ 8,95</div>
              <a href={LINK_METODO} className="btn-dark-mx">Quero por R$ 17</a>
            </div>
            ...
            <div style={{ background: "rgba(245,124,0,0.06)", border: "2px solid #F57C00", borderRadius: 18, padding: 32 }}>
              ...
              <div style={{ fontFamily: "'Outfit',sans-serif", fontWeight: 700, fontSize: 20, marginBottom: 6, color: "#ffffff" }}>Combo Ferramentas</div>
              ...
              <div style={{ fontFamily: "'Outfit',sans-serif", fontSize: 36, fontWeight: 800, color: "#F57C00", lineHeight: 1, marginBottom: 4 }}>R$ 197</div>
              <div style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", marginBottom: 20 }}>ou 10 x R$ 19,70</div>
              <a href={LINK_COMBO} className="btn-orange-full-mx">Quero por R$ 197</a>
            </div>
      ...
      <section className="sec-mx" style={{ padding: "80px 0", background: "#111111", borderTop: "1px solid rgba(255,255,255,0.08)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
          ...
          <h2 style={{ fontFamily: "'Outfit',sans-serif", fontSize: "clamp(26px,4vw,38px)", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 40, color: "#ffffff" }}>FAQ</h2>
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            <FaqItem q="Preciso saber de tecnologia para usar?" a="Não. Tudo é configurado para você — basta informar seus dados e as ferramentas ficam prontas para usar." />
            <FaqItem q="Funciona para qualquer estado?" a="As ferramentas funcionam em qualquer lugar do Brasil. O percentual de desconto disponível pode variar por região." />
            <FaqItem q="Já sou consultor de outra empresa. Posso usar?" a="Sim, desde que você atue com energia compartilhada. As ferramentas são independentes e se adaptam ao seu contexto." />
            <FaqItem q="Como recebo as ferramentas depois de comprar?" a="Assim que o pagamento é confirmado, o acesso é liberado e enviado por e-mail. Se precisar de ajuda na configuração, pode chamar pelo WhatsApp." />
            <FaqItem q="O script de IA conecta ao WhatsApp automaticamente?" a="Não. O script é uma instrução personalizada que você usa manualmente com ferramentas de IA para criar mensagens, responder objeções e qualificar clientes." />
          </div>
        </div>
      </section>

      {/* CTA FINAL */}
      <section className="sec-mx" style={{ padding: "100px 0", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 1 }}>
          <h2 style={{ fontFamily: "'Outfit',sans-serif", fontSize: "clamp(26px,4vw,38px)", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 16, maxWidth: 560, margin: "0 auto 16px", color: "#ffffff" }}>Pronto para vender com mais profissionalismo?</h2>
