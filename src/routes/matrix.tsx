...
// ↓↓↓ LINKS PADRÃO — substitua quando disponível
const LINK_METODO       = "#";
const LINK_PATROCINADOR = "#";
const LINK_FERRAMENTAS  = "#";
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .link-note{font-size:10px;color:rgba(245,124,0,0.4);letter-spacing:.06em;text-transform:uppercase;display:block;text-align:center;margin-top:6px;}
        ...
        .faq-arrow{flex-shrink:0;transition:transform .3s;stroke:#F57C00;}
        ...
        .faq-item.open .faq-ans{max-height:300px;padding:0 24px 20px;}
...
function FaqItem({q,a}:{q:string;a:string}) {
  ...
  return (
    <div className="faq-item" style={open?{borderColor:"rgba(245,124,0,0.2)"}:{}}>
      <button className="faq-btn outfit" onClick={()=>setOpen(!open)}>
        {q}
        <svg className="faq-arrow" width="18" height="18" viewBox="0 0 24 24" fill="none" strokeWidth="2" style={{transform:open?"rotate(45deg)":"none"}}>
